...
I built a data management tool in Excel to track/ manage employee access to certain data for 100+ employees and their access to data changes weekly. The automated Excel model centralizes locations for user input per entity. Users manage and update the information in one place. 
<br><br>
