...
>
>   In addition, it centralizes the path for data entry for employees’ (CDIs) information as users need to   update/ manage the employee information in one designated place ‘(Dropdown) CDI’. Users update all CDI-related information in the tab only.
> 
