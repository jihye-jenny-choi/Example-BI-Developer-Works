...
I built data management funtions in Excel to track/ manage employee access to certain data for 100+ employees and their access to data changes weekly. The automated Excel model centralizes locations for user input per entity. Users manage and update the information in one place. 
<br><br>

I created 5 spreadsheets (tabs) in the model as shown in <i>'Illustration 1-2-1'</i>. The first 3 tabs require manual user input and the remaining 2 tabs in blue are prepared automatically based on the manual user input in tab '(Input) Access'. 
<br><br>  
